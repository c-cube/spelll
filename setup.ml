...
(* OASIS_START *)
(* DO NOT EDIT (digest: 732d82d65425cee63a9131bab7d6855d) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$run_qcheck", []))];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/c-cube/spelll";
          synopsis =
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "run_qcheck.ml"});
               Test
                 ({
                     cs_name = "all";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Documentation for Spelll";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/c-cube/spelll";
                      src_repo_browser =
                        Some
                          "https://github.com/c-cube/spelll/tree/master/src";
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "xd\147\254\192\014\184L[\221\167\129z\031\240B";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
